...
namespace lpzrobots {
  ...
  public:
     ...
     * Constructor
     */
    OdeRobot(const OdeHandle& odeHandle, const VsgHandle& vsgHandle,
  ...
  public:
    ...
    */
    virtual void place(const vsg::dmat4& pose) final;

    /// wrapper to for @see place() that is to be overloaded
    virtual void placeIntern(const vsg::dmat4& pose) = 0;
